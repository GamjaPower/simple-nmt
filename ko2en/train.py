...
def test_preprocess():
  # 전처리 테스트
  en_sent = u"Do you think our climate has an influence on our character?"
  fr_sent = u"기후가 우리 성격에 영향을 준다고 생각하십니까?"

  print('전처리 전 영어 문장 :', en_sent)
  print('전처리 후 영어 문장 :',preprocess_sentence(en_sent))
  print('전처리 전 한글 문장 :', fr_sent)
  print('전처리 후 한글 문장 :', preprocess_sentence(fr_sent))
